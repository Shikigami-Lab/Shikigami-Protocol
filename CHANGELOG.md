...
- [ASE/Reflection] Better ASE — more natural and surprising proactive speech (see `docs/private/plans/better_ase.md`):
...
- [Sync] Added GitHub Actions quota management instructions and bundling details to `docs/private/sync.md`.
